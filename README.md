...
сформировать воспроизводимую итоговую модель в контейнере Docker
...
4.1. Постановка NLP-задачи
     (одна или несколько задач, например:
...
5.2. Полное дообучение модели (Full Fine-Tuning)
     Архитектура
     Настройки обучения
...
8. Формирование итоговой модели и обеспечение воспроизводимости
   
8.1. Выбор формата итоговой модели

8.2. Подготовка инференс-пайплайна

8.3. Контейнеризация решения

8.4. Docker-пайплайн воспроизведения

8.5. Документирование и инструкции
...
9.1. Повторный запуск модели в Docker

9.2. Сравнение результатов инференса
